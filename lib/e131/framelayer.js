...
function FrameLayer(buffer) {
  ...
  if (buffer === undefined) {
    buffer = Buffer.alloc(77, 0x00);
    buffer.writeUInt16BE(0x7258, 0); // flength
    buffer.writeUInt32BE(FrameLayer.VECTOR, 2); // vector
    buffer.writeUInt8(0x64, 70); // priority
    buffer.writeUInt16BE(0x0001, 75); // universe
  }
